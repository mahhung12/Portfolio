...
import { PiArrowDownBold, PiBriefcaseBold, PiGithubLogoBold, PiLinkBold } from "react-icons/pi";
...
const Project: React.FC<ProjectProps> = ({ icon, name, role, links }) => (
  <li className="flex gap-4">
    ...
    <dl className="flex flex-auto flex-wrap gap-x-2">
      ...
      <dd className="w-full flex-none text-sm font-medium text-zinc-900 dark:text-zinc-100">{name}</dd>
  ...
  return (
    <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
      ...
      <ol className="mt-6 space-y-4 ">
        ...
        <dd className="text-xs text-zinc-500 dark:text-zinc-400"> Coming soon...</dd>
      </ol>
      <Button
        href="https://apricot-april-15.tiiny.site/"
        target="_blank"
        variant="secondary"
