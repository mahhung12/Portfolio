...
const posts = [
  {
    id: 1,
    title: "Effortless Subtitling for Developers: Mastering Video Subtitles with FFmpeg",
    ...
    imageUrl: "https://miro.medium.com/v2/resize:fit:720/format:webp/1*ZVxwARTx7oiEh4bAX2rkPg.png",
    date: "Nov 29, 2023",
    datetime: "2023-11-29",
  ...
  },
  {
    ...
    imageUrl: "https://miro.medium.com/v2/resize:fit:720/format:webp/1*kSoiA_4LGYj9S5WW7gAERw.png",
    date: "Dec 1, 2023",
    datetime: "2023-12-01",
  ...
  {
    id: 3,
    title: "Top 6 No-Code Mobile App Builders of 2024: Revolutionizing App Development",
    ...
    imageUrl: "https://miro.medium.com/v2/resize:fit:720/format:webp/1*Z-hIXn0X7FSAY_DjmRO2Tw.png",
    date: "Dec 9, 2023",
    datetime: "2023-12-09",
    category: { title: "Developer", href: "#" },
  },
      ...
      <div className="sm:py-32">
        <div className="mx-auto px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            <h2 className="text-3xl font-bold tracking-tight text-zinc-800 dark:text-zinc-300 sm:text-4xl">Article</h2>
          ...
          {posts.length < 0 ? (
            ...
            <h2 className="text-3xl font-bold tracking-tight text-zinc-800 dark:text-zinc-300 sm:text-4xl w-full text-center mt-24">
              Coming soon
            </h2>
          )}
        </div>
