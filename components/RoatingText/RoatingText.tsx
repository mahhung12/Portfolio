...
import { forwardRef, useCallback, useEffect, useImperativeHandle, useMemo, useState, RefObject } from "react";
...
const RotatingText = forwardRef<RotatingTextRef, RotatingTextProps>((props: any, ref) => {
  const {
    texts,
